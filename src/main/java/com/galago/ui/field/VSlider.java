...
import com.galago.ui.Image;
import com.galago.ui.Label;
import com.galago.ui.button.ControlButton;
import com.galago.ui.listener.TouchButtonAdapter;
import com.galago.ui.listener.ValueChangeListener;
...
public class VSlider extends Panel {
  ...
  public VSlider(Panel parent, float height) {
    this(parent, "Interface/vslider.png", "Interface/button-sliderv.png", 54, height);
  }
