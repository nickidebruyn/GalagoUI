...
public class TextArea extends ImageWidget implements InputType {
  ...
  public TextArea(Panel panel, float width, float height) {
    this(panel, "some_area", "Interface/textarea.png", width, height, 5, new FontStyle(FontManager.DEFAULT_FONT, 18), false);
  ...
  public TextArea(Panel panel, String uid, float width, float height) {
    this(panel, uid, "Interface/textarea.png", width, height, 5, new FontStyle(FontManager.DEFAULT_FONT, 18), false);
